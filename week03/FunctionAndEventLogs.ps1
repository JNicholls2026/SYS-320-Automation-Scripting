...
$loginoutsTable += [PSCustomObject]@{"Time" = $loginouts[$i].TimeGenerated; "Id" = $loginouts[$i].InstanceId; "Event" = $event; "User" = $user;
                                    }
    }
...
# Calls both funtions then prints the results
$DaysToRetrieve = 14
