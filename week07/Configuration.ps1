...
$ConfigPath = "C:\Users\jnicholls\SYS-320-Automation-Scripting\week08\configuration.txt"
...
function changeConfiguration {
    $days = Read-Host "Enter number of days (numbers only)"
...
while ($true) {
    ...
    if ($choice -eq "1") {
        ...
        Write-Host "ERROR: Invalid choice (Enter 1, 2, or 3)"
    }
}